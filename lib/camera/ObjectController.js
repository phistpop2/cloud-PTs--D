    ...
    return {
        ...
        getCenterPosition : function(w, h){
            ...
            for( var i = 0; i < 4; i++ ){
                ...
                console.debug( 'edge['+i+']', parseInt( newX ), parseInt( newY ), ";", edge[i].getX(), edge[i].getY(), edge[i].getZ() );
            }
        ...
        getAbsoluteEdges : function(src, w,h){
            ...
            var q =  quaternion().cross( parent.getQuaternion(), mQuaternion );
            var xq = quaternion().fromAxisAngle( vector3(0, -1, 0), 180 );
           // q = xq.crossBy( q );
            var zq = quaternion().fromAxisAngle( vector3(0, 0, 1), 180 );
           // q = zq.crossBy( q );
