            ...
            function parseToWord(el)
            {
                ...
                for(var i =0 ; i < contents.length ; i++)
                {
                    ...
                    else if(content.nodeType==3)
                    {
                        ...
                        {
                            console.log('content parentElement',content,parentElement);
                            for(var i = 0 ; i < contentCharacter.length ; i++)
                            {
                                var style = '';
                                if(parentElement && $(parentElement).hasClass('lcWord'))
                                {
                                    style += $(parentElement).attr('style');
                                    console.log("$(parentElement).attr('style')",$(parentElement).attr('style'));
                                }
                                lcWords += ('<span class=lcWord style="'+style+'">' +contentCharacter[i]+'</span>');
                            }
